...
| `scripts/pipeline-metrics/testdata/`             | 新規（`issues.json` / `prs.json` / `golden.md`）                                                      |
...
- [ ] 実データでの手計算と CLI 出力が一致する: スキャン別採用率（nvim 43/53・scripts 8/13・ai-agents 8/9・ci 8/8・environment 8/8）、`auto/*` merged 62 / 未マージ close 4、`rejected ∧ pr-created` 2 件（#518 / #446）
